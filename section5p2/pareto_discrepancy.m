...
if Flag.save == 1
    saveas(gcf, strcat('discr_Pareto_1_alpha',num2str(param.alpha)), 'epsc');
end
...
if Flag.save == 1
    saveas(gcf, strcat('discr_Pareto_2_alpha',num2str(param.alpha)), 'epsc');
end
...
ylabel('Discrepancy of compliance (J)', 'Interpreter', 'latex');
if Flag.save == 1
    saveas(gcf, strcat('discr_Pareto_3_alpha',num2str(param.alpha)), 'epsc');
end
